...
@Entity
@Table(name = "pgmeas_s_intervento_struttura")
@Data
public class InterventoStrutturaStorico extends BaseEntity implements Serializable{

    /**
	 * 
	 */
	private static final long serialVersionUID = 125167070608024206L;

	@Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "s_intstr_id")
    private Integer sIntStrId;

    @Column(name = "intstr_id", nullable = false)
